...
declare module angular {
    ...
    */
    ...
    interface IAugmentedJQuery extends JQuery {
        ...
        //$destroy
        ajaxComplete(handler: (event: JQueryEventObject, XMLHttpRequest: XMLHttpRequest, ajaxOptions: any) => any): IAugmentedJQuery;
        ajaxError(handler: (event: JQueryEventObject, jqXHR: JQueryXHR, ajaxSettings: JQueryAjaxSettings, thrownError: any) => any): IAugmentedJQuery;
        ajaxSend(handler: (event: JQueryEventObject, jqXHR: JQueryXHR, ajaxOptions: JQueryAjaxSettings) => any): IAugmentedJQuery;
        ajaxStart(handler: () => any): IAugmentedJQuery;
        ajaxStop(handler: () => any): IAugmentedJQuery;
        ajaxSuccess(handler: (event: JQueryEventObject, XMLHttpRequest: XMLHttpRequest, ajaxOptions: JQueryAjaxSettings) => any): IAugmentedJQuery;
    
        load(url: string, data?: string|Object, complete?: (responseText: string, textStatus: string, XMLHttpRequest: XMLHttpRequest) => any): IAugmentedJQuery;
    
        serialize(): string;
        serializeArray(): JQuerySerializeArrayElement[];
    
        addClass(className: string): IAugmentedJQuery;
        addClass(func: (index: number, className: string) => string): IAugmentedJQuery;
    
        addBack(selector?: string): IAugmentedJQuery;
    
        attr(attributeName: string): string;
        attr(attributeName: string, value: string|number): IAugmentedJQuery;
        attr(attributeName: string, func: (index: number, attr: string) => string|number): IAugmentedJQuery;
        attr(attributes: Object): IAugmentedJQuery;
        
        hasClass(className: string): boolean;
    
        html(): string;
        html(htmlString: string): IAugmentedJQuery;
        html(func: (index: number, oldhtml: string) => string): IAugmentedJQuery;
    
        prop(propertyName: string): any;
        prop(propertyName: string, value: string|number|boolean): IAugmentedJQuery;
        prop(properties: Object): IAugmentedJQuery;
        prop(propertyName: string, func: (index: number, oldPropertyValue: any) => any): IAugmentedJQuery;
    
        removeAttr(attributeName: string): IAugmentedJQuery;
    
        removeClass(className?: string): IAugmentedJQuery;
        removeClass(func: (index: number, className: string) => string): IAugmentedJQuery;
    
        removeProp(propertyName: string): IAugmentedJQuery;
    
        toggleClass(className: string, swtch?: boolean): IAugmentedJQuery;
        toggleClass(swtch?: boolean): IAugmentedJQuery;
        toggleClass(func: (index: number, className: string, swtch: boolean) => string, swtch?: boolean): IAugmentedJQuery;
    
        val(): any;
        val(value: string|string[]): IAugmentedJQuery;
        val(func: (index: number, value: string) => string): IAugmentedJQuery;
    
    
        css(propertyName: string): string;
        css(propertyName: string, value: string|number): IAugmentedJQuery;
        css(propertyName: string, value: (index: number, value: string) => string|number): IAugmentedJQuery;
        css(properties: Object): IAugmentedJQuery;
    
        height(): number;
        height(value: number|string): IAugmentedJQuery;
        height(func: (index: number, height: number) => number|string): IAugmentedJQuery;
    
        innerHeight(): number;
    
        innerHeight(height: number|string): IAugmentedJQuery;
        
        innerWidth(): number;
    
        innerWidth(width: number|string): IAugmentedJQuery;
        
        offset(): JQueryCoordinates;
        offset(coordinates: JQueryCoordinates): IAugmentedJQuery;
        offset(func: (index: number, coords: JQueryCoordinates) => JQueryCoordinates): IAugmentedJQuery;
    
        outerHeight(includeMargin?: boolean): number;
    
        outerHeight(height: number|string): IAugmentedJQuery;
    
        outerWidth(includeMargin?: boolean): number;
    
        outerWidth(width: number|string): IAugmentedJQuery;
    
        position(): JQueryCoordinates;
    
        scrollLeft(): number;
        scrollLeft(value: number): IAugmentedJQuery;
    
        scrollTop(): number;
        scrollTop(value: number): IAugmentedJQuery;
    
        width(): number;
        width(value: number|string): IAugmentedJQuery;
        width(func: (index: number, width: number) => number|string): IAugmentedJQuery;
    
        clearQueue(queueName?: string): IAugmentedJQuery;
    
        data(key: string, value: any): IAugmentedJQuery;
        data(obj: { [key: string]: any; }): IAugmentedJQuery;
        data(key: string): any;
        data(): any;
    
        dequeue(queueName?: string): IAugmentedJQuery;
    
        removeData(name: string): IAugmentedJQuery;
        removeData(list: string[]): IAugmentedJQuery;
    
        promise(type?: string, target?: Object): JQueryPromise<any>;
    
        animate(properties: Object, duration?: string|number, complete?: Function): IAugmentedJQuery;
        animate(properties: Object, duration?: string|number, easing?: string, complete?: Function): IAugmentedJQuery;
        animate(properties: Object, options: JQueryAnimationOptions): IAugmentedJQuery;
    
        delay(duration: number, queueName?: string): IAugmentedJQuery;
    
        fadeIn(duration?: number|string, complete?: Function): IAugmentedJQuery;
        fadeIn(duration?: number|string, easing?: string, complete?: Function): IAugmentedJQuery;
        fadeIn(options: JQueryAnimationOptions): IAugmentedJQuery;
    
        fadeOut(duration?: number|string, complete?: Function): IAugmentedJQuery;
        fadeOut(duration?: number|string, easing?: string, complete?: Function): IAugmentedJQuery;
        fadeOut(options: JQueryAnimationOptions): IAugmentedJQuery;
    
        fadeTo(duration: string|number, opacity: number, complete?: Function): IAugmentedJQuery;
        fadeTo(duration: string|number, opacity: number, easing?: string, complete?: Function): IAugmentedJQuery;
    
        fadeToggle(duration?: number|string, complete?: Function): IAugmentedJQuery;
        fadeToggle(duration?: number|string, easing?: string, complete?: Function): IAugmentedJQuery;
        fadeToggle(options: JQueryAnimationOptions): IAugmentedJQuery;
    
        finish(queue?: string): IAugmentedJQuery;
    
        hide(duration?: number|string, complete?: Function): IAugmentedJQuery;
        hide(duration?: number|string, easing?: string, complete?: Function): IAugmentedJQuery;
        hide(options: JQueryAnimationOptions): IAugmentedJQuery;
    
        show(duration?: number|string, complete?: Function): IAugmentedJQuery;
        show(duration?: number|string, easing?: string, complete?: Function): IAugmentedJQuery;
        show(options: JQueryAnimationOptions): IAugmentedJQuery;
    
        slideDown(duration?: number|string, complete?: Function): IAugmentedJQuery;
        slideDown(duration?: number|string, easing?: string, complete?: Function): IAugmentedJQuery;
        slideDown(options: JQueryAnimationOptions): IAugmentedJQuery;
    
        slideToggle(duration?: number|string, complete?: Function): IAugmentedJQuery;
        slideToggle(duration?: number|string, easing?: string, complete?: Function): IAugmentedJQuery;
        slideToggle(options: JQueryAnimationOptions): IAugmentedJQuery;
    
        slideUp(duration?: number|string, complete?: Function): IAugmentedJQuery;
        slideUp(duration?: number|string, easing?: string, complete?: Function): IAugmentedJQuery;
        slideUp(options: JQueryAnimationOptions): IAugmentedJQuery;
    
        stop(clearQueue?: boolean, jumpToEnd?: boolean): IAugmentedJQuery;
        stop(queue?: string, clearQueue?: boolean, jumpToEnd?: boolean): IAugmentedJQuery;
    
        toggle(duration?: number|string, complete?: Function): IAugmentedJQuery;
        toggle(duration?: number|string, easing?: string, complete?: Function): IAugmentedJQuery;
        toggle(options: JQueryAnimationOptions): IAugmentedJQuery;
        toggle(showOrHide: boolean): IAugmentedJQuery;
    
        bind(eventType: string, eventData: any, handler: (eventObject: JQueryEventObject) => any): IAugmentedJQuery;
        bind(eventType: string, handler: (eventObject: JQueryEventObject) => any): IAugmentedJQuery;
        bind(eventType: string, eventData: any, preventBubble: boolean): IAugmentedJQuery;
        bind(eventType: string, preventBubble: boolean): IAugmentedJQuery;
        bind(events: any): IAugmentedJQuery;
    
        blur(): IAugmentedJQuery;
        blur(handler: (eventObject: JQueryEventObject) => any): IAugmentedJQuery;
        blur(eventData?: any, handler?: (eventObject: JQueryEventObject) => any): IAugmentedJQuery;
    
        change(): IAugmentedJQuery;
        change(handler: (eventObject: JQueryEventObject) => any): IAugmentedJQuery;
        change(eventData?: any, handler?: (eventObject: JQueryEventObject) => any): IAugmentedJQuery;
    
        click(): IAugmentedJQuery;
        click(handler: (eventObject: JQueryEventObject) => any): IAugmentedJQuery;
        click(eventData?: any, handler?: (eventObject: JQueryEventObject) => any): IAugmentedJQuery;
    
        dblclick(): IAugmentedJQuery;
        dblclick(handler: (eventObject: JQueryEventObject) => any): IAugmentedJQuery;
        dblclick(eventData?: any, handler?: (eventObject: JQueryEventObject) => any): IAugmentedJQuery;
    
        delegate(selector: any, eventType: string, handler: (eventObject: JQueryEventObject) => any): IAugmentedJQuery;
        delegate(selector: any, eventType: string, eventData: any, handler: (eventObject: JQueryEventObject) => any): IAugmentedJQuery;
    
        focus(): IAugmentedJQuery;
        focus(handler: (eventObject: JQueryEventObject) => any): IAugmentedJQuery;
        focus(eventData?: any, handler?: (eventObject: JQueryEventObject) => any): IAugmentedJQuery;
    
        focusin(handler: (eventObject: JQueryEventObject) => any): IAugmentedJQuery;
        focusin(eventData: Object, handler: (eventObject: JQueryEventObject) => any): IAugmentedJQuery;
    
        focusout(handler: (eventObject: JQueryEventObject) => any): IAugmentedJQuery;
        focusout(eventData: Object, handler: (eventObject: JQueryEventObject) => any): IAugmentedJQuery;
    
        hover(handlerIn: (eventObject: JQueryEventObject) => any, handlerOut: (eventObject: JQueryEventObject) => any): IAugmentedJQuery;
        hover(handlerInOut: (eventObject: JQueryEventObject) => any): IAugmentedJQuery;
    
        keydown(): IAugmentedJQuery;
        keydown(handler: (eventObject: JQueryKeyEventObject) => any): IAugmentedJQuery;
        keydown(eventData?: any, handler?: (eventObject: JQueryKeyEventObject) => any): IAugmentedJQuery;
    
        keypress(): IAugmentedJQuery;
        keypress(handler: (eventObject: JQueryKeyEventObject) => any): IAugmentedJQuery;
        keypress(eventData?: any, handler?: (eventObject: JQueryKeyEventObject) => any): IAugmentedJQuery;
    
        keyup(): IAugmentedJQuery;
        keyup(handler: (eventObject: JQueryKeyEventObject) => any): IAugmentedJQuery;
        keyup(eventData?: any, handler?: (eventObject: JQueryKeyEventObject) => any): IAugmentedJQuery;
    
        load(handler: (eventObject: JQueryEventObject) => any): IAugmentedJQuery;
        load(eventData?: any, handler?: (eventObject: JQueryEventObject) => any): IAugmentedJQuery;
    
        mousedown(): IAugmentedJQuery;
        mousedown(handler: (eventObject: JQueryMouseEventObject) => any): IAugmentedJQuery;
        mousedown(eventData: Object, handler: (eventObject: JQueryMouseEventObject) => any): IAugmentedJQuery;
    
        mouseenter(): IAugmentedJQuery;
        mouseenter(handler: (eventObject: JQueryMouseEventObject) => any): IAugmentedJQuery;
        mouseenter(eventData: Object, handler: (eventObject: JQueryMouseEventObject) => any): IAugmentedJQuery;
    
        mouseleave(): IAugmentedJQuery;
        mouseleave(handler: (eventObject: JQueryMouseEventObject) => any): IAugmentedJQuery;
        mouseleave(eventData: Object, handler: (eventObject: JQueryMouseEventObject) => any): IAugmentedJQuery;
    
        mousemove(): IAugmentedJQuery;
        mousemove(handler: (eventObject: JQueryMouseEventObject) => any): IAugmentedJQuery;
        mousemove(eventData: Object, handler: (eventObject: JQueryMouseEventObject) => any): IAugmentedJQuery;
    
        mouseout(): IAugmentedJQuery;
        mouseout(handler: (eventObject: JQueryMouseEventObject) => any): IAugmentedJQuery;
        mouseout(eventData: Object, handler: (eventObject: JQueryMouseEventObject) => any): IAugmentedJQuery;
    
        mouseover(): IAugmentedJQuery;
        mouseover(handler: (eventObject: JQueryMouseEventObject) => any): IAugmentedJQuery;
        mouseover(eventData: Object, handler: (eventObject: JQueryMouseEventObject) => any): IAugmentedJQuery;
    
        mouseup(): IAugmentedJQuery;
        mouseup(handler: (eventObject: JQueryMouseEventObject) => any): IAugmentedJQuery;
        mouseup(eventData: Object, handler: (eventObject: JQueryMouseEventObject) => any): IAugmentedJQuery;
    
        off(): IAugmentedJQuery;
        off(events: string, selector?: string, handler?: (eventObject: JQueryEventObject) => any): IAugmentedJQuery;
        off(events: string, handler: (eventObject: JQueryEventObject) => any): IAugmentedJQuery;
        off(events: { [key: string]: any; }, selector?: string): IAugmentedJQuery;
    
        on(events: string, handler: (eventObject: JQueryEventObject, ...args: any[]) => any): IAugmentedJQuery;
        on(events: string, data : any, handler: (eventObject: JQueryEventObject, ...args: any[]) => any): IAugmentedJQuery;
        on(events: string, selector: string, handler: (eventObject: JQueryEventObject, ...eventData: any[]) => any): IAugmentedJQuery;
        on(events: string, selector: string, data: any, handler: (eventObject: JQueryEventObject, ...eventData: any[]) => any): IAugmentedJQuery;
        on(events: { [key: string]: any; }, selector?: string, data?: any): IAugmentedJQuery;
        on(events: { [key: string]: any; }, data?: any): IAugmentedJQuery;
    
        one(events: string, handler: (eventObject: JQueryEventObject) => any): IAugmentedJQuery;
        one(events: string, data: Object, handler: (eventObject: JQueryEventObject) => any): IAugmentedJQuery;
    
        one(events: string, selector: string, handler: (eventObject: JQueryEventObject) => any): IAugmentedJQuery;
        one(events: string, selector: string, data: any, handler: (eventObject: JQueryEventObject) => any): IAugmentedJQuery;
    
        one(events: { [key: string]: any; }, selector?: string, data?: any): IAugmentedJQuery;
    
        one(events: { [key: string]: any; }, data?: any): IAugmentedJQuery;
    
    
        ready(handler: (jQueryAlias?: JQueryStatic) => any): IAugmentedJQuery;
    
        resize(): IAugmentedJQuery;
        resize(handler: (eventObject: JQueryEventObject) => any): IAugmentedJQuery;
        resize(eventData: Object, handler: (eventObject: JQueryEventObject) => any): IAugmentedJQuery;
    
        scroll(): IAugmentedJQuery;
        scroll(handler: (eventObject: JQueryEventObject) => any): IAugmentedJQuery;
        scroll(eventData: Object, handler: (eventObject: JQueryEventObject) => any): IAugmentedJQuery;
    
        select(): IAugmentedJQuery;
        select(handler: (eventObject: JQueryEventObject) => any): IAugmentedJQuery;
        select(eventData: Object, handler: (eventObject: JQueryEventObject) => any): IAugmentedJQuery;
    
        submit(): IAugmentedJQuery;
        submit(handler: (eventObject: JQueryEventObject) => any): IAugmentedJQuery;
        submit(eventData?: any, handler?: (eventObject: JQueryEventObject) => any): IAugmentedJQuery;
    
        trigger(eventType: string, extraParameters?: any[]|Object): IAugmentedJQuery;
        trigger(event: JQueryEventObject, extraParameters?: any[]|Object): IAugmentedJQuery;
    
        triggerHandler(eventType: string, ...extraParameters: any[]): Object;
    
        unbind(eventType?: string, handler?: (eventObject: JQueryEventObject) => any): IAugmentedJQuery;
        unbind(eventType: string, fls: boolean): IAugmentedJQuery;
        unbind(evt: any): IAugmentedJQuery;
    
        undelegate(): IAugmentedJQuery;
        undelegate(selector: string, eventType: string, handler?: (eventObject: JQueryEventObject) => any): IAugmentedJQuery;
        undelegate(selector: string, events: Object): IAugmentedJQuery;
        undelegate(namespace: string): IAugmentedJQuery;
    
        unload(handler: (eventObject: JQueryEventObject) => any): IAugmentedJQuery;
        unload(eventData?: any, handler?: (eventObject: JQueryEventObject) => any): IAugmentedJQuery;
    
        context: Element;
    
        jquery: string;
    
        error(handler: (eventObject: JQueryEventObject) => any): IAugmentedJQuery;
        error(eventData: any, handler: (eventObject: JQueryEventObject) => any): IAugmentedJQuery;
    
        pushStack(elements: any[]): IAugmentedJQuery;
        pushStack(elements: any[], name: string, arguments: any[]): IAugmentedJQuery;
    
        after(content1: JQuery|any[]|Element|Text|string, ...content2: any[]): IAugmentedJQuery;
        after(func: (index: number, html: string) => string|Element|JQuery): IAugmentedJQuery;
    
        append(content1: JQuery|any[]|Element|Text|string, ...content2: any[]): IAugmentedJQuery;
        append(func: (index: number, html: string) => string|Element|JQuery): IAugmentedJQuery;
    
        appendTo(target: JQuery|any[]|Element|string): IAugmentedJQuery;
    
        before(content1: JQuery|any[]|Element|Text|string, ...content2: any[]): IAugmentedJQuery;
        before(func: (index: number, html: string) => string|Element|JQuery): IAugmentedJQuery;
    
        clone(withDataAndEvents?: boolean, deepWithDataAndEvents?: boolean): IAugmentedJQuery;
    
        detach(selector?: string): IAugmentedJQuery;
    
        empty(): IAugmentedJQuery;
    
        insertAfter(target: JQuery|any[]|Element|Text|string): IAugmentedJQuery;
    
        insertBefore(target: JQuery|any[]|Element|Text|string): IAugmentedJQuery;
    
        prepend(content1: JQuery|any[]|Element|Text|string, ...content2: any[]): IAugmentedJQuery;
        prepend(func: (index: number, html: string) => string|Element|JQuery): IAugmentedJQuery;
    
        prependTo(target: JQuery|any[]|Element|string): IAugmentedJQuery;
    
        remove(selector?: string): IAugmentedJQuery;
    
        replaceAll(target: JQuery|any[]|Element|string): IAugmentedJQuery;
    
        replaceWith(newContent: JQuery|any[]|Element|Text|string): IAugmentedJQuery;
        replaceWith(func: () => Element|JQuery): IAugmentedJQuery;
    
        text(): string;
        text(text: string|number|boolean): IAugmentedJQuery;
        text(func: (index: number, text: string) => string): IAugmentedJQuery;
    
        toArray(): any[];
    
        unwrap(): IAugmentedJQuery;
    
        wrap(wrappingElement: JQuery|Element|string): IAugmentedJQuery;
        wrap(func: (index: number) => string|JQuery): IAugmentedJQuery;
    
        wrapAll(wrappingElement: JQuery|Element|string): IAugmentedJQuery;
        wrapAll(func: (index: number) => string): IAugmentedJQuery;
    
        wrapInner(wrappingElement: JQuery|Element|string): IAugmentedJQuery;
        wrapInner(func: (index: number) => string): IAugmentedJQuery;
    
        each(func: (index: number, elem: Element) => any): IAugmentedJQuery;
        ...
        add(selector: string, context?: Element): IAugmentedJQuery;
        add(...elements: Element[]): IAugmentedJQuery;
        add(html: string): IAugmentedJQuery;
        add(obj: JQuery): IAugmentedJQuery;
    
        children(selector?: string): IAugmentedJQuery;
    
        closest(selector: string): IAugmentedJQuery;
        closest(selector: string, context?: Element): IAugmentedJQuery;
        closest(obj: JQuery): IAugmentedJQuery;
        closest(element: Element): IAugmentedJQuery;
    
        closest(selectors: any, context?: Element): any[];
    
        contents(): IAugmentedJQuery;
    
        end(): IAugmentedJQuery;
    
        eq(index: number): IAugmentedJQuery;
    
        filter(selector: string): IAugmentedJQuery;
        filter(func: (index: number, element: Element) => any): IAugmentedJQuery;
        filter(element: Element): IAugmentedJQuery;
        filter(obj: JQuery): IAugmentedJQuery;
    
        find(selector: string): IAugmentedJQuery;
        find(element: Element): IAugmentedJQuery;
        find(obj: JQuery): IAugmentedJQuery;
    
        first(): IAugmentedJQuery;
    
        has(selector: string): IAugmentedJQuery;
        has(contained: Element): IAugmentedJQuery;
        ...
        last(): IAugmentedJQuery;
    
        map(callback: (index: number, domElement: Element) => any): IAugmentedJQuery;
    
        next(selector?: string): IAugmentedJQuery;
    
        nextAll(selector?: string): IAugmentedJQuery;
    
        nextUntil(selector?: string, filter?: string): IAugmentedJQuery;
        nextUntil(element?: Element, filter?: string): IAugmentedJQuery;
        nextUntil(obj?: JQuery, filter?: string): IAugmentedJQuery;
    
        not(selector: string): IAugmentedJQuery;
        not(func: (index: number, element: Element) => boolean): IAugmentedJQuery;
        not(...elements: Element[]): IAugmentedJQuery;
        not(obj: JQuery): IAugmentedJQuery;
    
        offsetParent(): IAugmentedJQuery;
    
        parent(selector?: string): IAugmentedJQuery;
    
        parents(selector?: string): IAugmentedJQuery;
    
        parentsUntil(selector?: string, filter?: string): IAugmentedJQuery;
        parentsUntil(element?: Element, filter?: string): IAugmentedJQuery;
        parentsUntil(obj?: JQuery, filter?: string): IAugmentedJQuery;
    
        prev(selector?: string): IAugmentedJQuery;
    
        prevAll(selector?: string): IAugmentedJQuery;
    
        prevUntil(selector?: string, filter?: string): IAugmentedJQuery;
        prevUntil(element?: Element, filter?: string): IAugmentedJQuery;
        prevUntil(obj?: JQuery, filter?: string): IAugmentedJQuery;
    
        siblings(selector?: string): IAugmentedJQuery;
    
        slice(start: number, end?: number): IAugmentedJQuery;
    
        queue(queueName?: string): any[];
        queue(newQueue: Function[]): IAugmentedJQuery;
        queue(callback: Function): IAugmentedJQuery;
        queue(queueName: string, newQueue: Function[]): IAugmentedJQuery;
        queue(queueName: string, callback: Function): IAugmentedJQuery;
